...
{
  MatrixXd matrix(3, 3);
  matrix << matrixIO::openData("../data/m3.csv", 3);
  ...
  BOOST_TEST(matrix(0, 1) == expectedMatrix(0, 1));
  BOOST_TEST(matrix(0, 2) == expectedMatrix(0, 2));
  BOOST_TEST(matrix(1, 0) == expectedMatrix(1, 0));
  BOOST_TEST(matrix(1, 1) == expectedMatrix(1, 1));
  BOOST_TEST(matrix(1, 2) == expectedMatrix(1, 2));
  BOOST_TEST(matrix(2, 0) == expectedMatrix(2, 0));
  BOOST_TEST(matrix(2, 1) == expectedMatrix(2, 1));
